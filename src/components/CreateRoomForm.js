...
const CreateRoomForm = ({ history }) => {
    ...
    return (
        <form className="Createroom-outer-form">
            ...
            <div className="form-group">
                <h5>최대인원*</h5>
                <button className="ppl-btn" onClick={increaseNum}>
                    +
                </button>
                <p>{textNum}</p>
                <button className="ppl-btn" onClick={decreaseNum}>
                    -
                </button>
            </div>
            <div className="form-group">
            ...
            <div className="form-group2">
                <h5>공부방 에티켓</h5>
                <textarea rows="5" onChange={(e) => inputManner(e)}></textarea>
            </div>
            <div className="form-group-color">
                ...
                <div className="room-colors">
                    ...
                    <div
                        className="room-color"
                        id="rc2"
                        onClick={() => selectColor("rc2")}
                    ></div>
                    <div
                        className="room-color"
                        id="rc3"
                        onClick={() => selectColor("rc3")}
                    ></div>
                    <div
                        className="room-color"
                        id="rc4"
                        onClick={() => selectColor("rc4")}
                    ></div>
                </div>
            </div>
